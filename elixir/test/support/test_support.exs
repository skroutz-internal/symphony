defmodule SymphonyElixir.TestSupport do
  ...
  defp workflow_content(overrides) do
    config =
      Keyword.merge(
        [
          ...
          hook_before_symphony_run: nil,
          hook_before_run: nil,
          hook_after_run: nil,
          hook_after_symphony_run: nil,
    ...
    hook_before_symphony_run = Keyword.get(config, :hook_before_symphony_run)
    hook_before_run = Keyword.get(config, :hook_before_run)
    hook_after_run = Keyword.get(config, :hook_after_run)
    hook_after_symphony_run = Keyword.get(config, :hook_after_symphony_run)
    ...
    sections =
      [
        ...
        hooks_yaml(
          hook_after_create,
          hook_before_symphony_run,
          hook_before_run,
          hook_after_run,
          hook_after_symphony_run,
          hook_before_remove,
          hook_timeout_ms
        ),
  ...
  defp hooks_yaml(
    ...
    [
      ...
      hook_entry("before_symphony_run", hook_before_symphony_run),
      hook_entry("before_run", hook_before_run),
      hook_entry("after_run", hook_after_run),
      hook_entry("after_symphony_run", hook_after_symphony_run),
